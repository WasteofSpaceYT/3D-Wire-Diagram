...
<div style="margin: 20px">
    ...
    <table style="display: flex">
        ...
        <tr style="margin-left: 5px"><td style="margin-right: 5px; justify-content: center; vertical-align: middle;">Tile:</td> 
        ...
        <tr style="margin-left: 5px"><td style="margin-right: 5px; justify-content: center; vertical-align: middle;">Carpet:</td> 
